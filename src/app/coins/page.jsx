...
const DropdownGrid = () => {
  ...
  return (
    <div className="flex w-full max-w-7xl mx-auto p-4">
      <div
        className={`grid bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 ${
      ...
      >
        ...
        >
          ...
          >
            ...
            tempor venenatis justo, a dictum risus tincidunt id. Quisque euismod
            facilisis magna, et sodales nisi eleifend at. Ut venenatis lectus eu
            arcu commodo, id tincidunt augue porttitor.
          </p>

    ...
    <div className="">
      <div className="lg:p-24 md:px-5 px-2 py-8 ">
        ...
        <div className=" relative ">
          ...
          />
          <div className=" absolute inset-0 flex flex-col justify-center items-center top-64 md:top-52 xl:top-80 ">
            <h2 className=" text-center text-2xl md:text-4xl xl:text-7xl py-3 xl:py-5">

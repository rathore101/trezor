    ...
    <div className=" relative">
      <div className="grid sm:grid-cols-2  bg-white my-4 px-4 rounded-xl">
        <div className="my-5 px-0">
          <h2 className="md:text-5xl xl:text-6xl text-3xl pr-4 py-1 md:py-3 md:mb-2  text-black">
            Coin Management
          </h2>
      ...
      <div className="hidden md:block">
        <div className="grid sm:grid-cols-2  bg-white my-4 px-4 rounded-xl">
          ...
          <div className="my-5 px-7">
            <h2 className="md:text-5xl xl:text-6xl text-3xl py-1 md:py-3 md:mb-2 text-black ">
              Check & Verify
            </h2>
            <p className="text-xl lg:text-2xl md:text-xl text-[#0f6148] lg:mb-10 mb-5 ">

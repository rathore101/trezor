  ...
  return (
    <div className="">
      <div className="">
        ...
        <nav className="flex h-14 md:h-20 gap-3 px-5 w-full max-w-full mt-2 mx-0 md:mx-10  fixed z-50">
          <div className="rounded-full w-[80%] 2xl:w-[85%] py-3 bg-white shadow-sm flex justify-between items-center px-5">
            ...
            <div className="hidden lg:block">
              <ul className="flex gap-14 text-[#797979]  ">
                ...
                <Link href="/trezor-suite" className=" hover:text-gray-700">
                  App
                </Link>
                <Link href="/coins" className=" hover:text-gray-700">
                  Coins
                </Link>
                <Link href="/learn&support" className=" hover:text-gray-700">
                  Learn & Support
                </Link>
              </ul>
            </div>
          ...
          <div className="flex justify-center  w-auto  text-white items-center  rounded-full bg-[#0f6148]">
            ...
            <div className="lg:hidden rounded-full p-3 bg-[#0f6148]  size-[52px] ">
              <GetBtnIcon />
            </div>
          </div>
        </nav>
